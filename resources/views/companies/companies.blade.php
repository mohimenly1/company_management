    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <a href="companies/create" class="modal-effect btn btn-sm btn-primary" style="color:white">
                    <i class="fas fa-plus"></i>&nbsp; اضافة شركة 
                </a>
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">عنوان الشركة</th>
