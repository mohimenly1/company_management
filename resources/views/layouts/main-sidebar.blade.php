...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category"> PRO MANAGE</li>
            <li class="slide">
            ...
            <li class="side-item side-item-category">الشركات </li>
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('اضافة شركة')
                            <li><a class="slide-item" href="{{ route('companies.create') }}">اضافة شركة  </a></li>
                        
                        @endcan

                      @can('قائمة الشركات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'companies')) }}">قائمة الشركات </a></li>
                      @endcan
                    </ul>
                </li>
                @endcan
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">المشاريع</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                    

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'projects')) }}">قائمة المشاريع</a></li>

                   

                    

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Paid')) }}">المشاريع المنجزة</a>


                        </li>

                       
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_UnPaid')) }}">المشاريع 
                                    المكتملة </a>
                            </li>
                    

                        
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Partial')) }}">المشاريع المتوقفة 
                                    جزئيا</a>
                            </li>
              

                     
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Archive')) }}">ارشيف المشاريع</a></li>
                     
                    </ul>
                </li>
        

                <li class="side-item side-item-category">الفرق</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            ...
                            <path
                                d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                        </svg><span class="side-menu__label">الفرق</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        
                            <li><a class="slide-item" href="{{  url('/' . ($page = 'teams')) }}">انشاء فريق</a></li>
                        

                      
                            {{-- <li><a class="slide-item" href="{{ url('/' . ($page = 'Team')) }}">اضافة اعضاء للفريق</a></li> --}}
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'team_members')) }}">قائمة الفرق</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                        </svg><span class="side-menu__label">المهام</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        
                        <li><a class="slide-item" href="{{ url('/tasks/create') }}">اضافة مهام</a></li>

                        

                      
                         <li><a class="slide-item" href="{{ url('/tasks-show') }}">عرض المهام</a></li>
                ...
                <li class="side-item side-item-category">دردشة مع الاعضاء</li>
<li class="slide">
    <a class="side-menu__item" href="{{ url('team-members/chat') }}">
        ...
        <span class="side-menu__label">أعضاء الفريق</span>
    </a>
</li>
           ...
           @can('المستخدمين')
                ...
                <li class="side-item side-item-category">الموارد</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">الموارد</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                  
                    <li><a class="slide-item" href="/">اضافة مورد</a></li>
                       
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Resource')) }}">قائمة الموارد</a></li>
